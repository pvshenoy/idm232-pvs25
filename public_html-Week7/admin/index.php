...
<body>
    <header>
        ...
        <div class="menu">
            ...
            <div class="menu_item search-icon"><img src="components/images/search.png" alt="search"></div>
        </div>
    </header>
    <main>
        <div class="hero_content">
            ...
            <div class="hero">
                <img class="hero_img" src="components/images/hero_img.png" alt="fragrance-hero">
            </div>
        </div>
        <h1 style="margin-right: 4rem;">Explore all fragrances</h1>
        <section class="perfume-list">
            <div class="perfume">
                <div class="perfume-img"><img src="components/images/Group 12.png" alt="dior ADDICT"></div>
