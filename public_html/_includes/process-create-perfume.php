...
$result = add_perfume($perfumeName_value, $type_value, $brand_value, $image_value, $description_value, $topNote_value, $middleNote_value, $bottomNote_value);

// Check there are no errors with our SQL statement
if ($result) {
    redirect_to('/admin/perfumes');
} else {
    $error_message = 'Sorry there was an error creating the perfume ' . mysqli_error($db_connection);
