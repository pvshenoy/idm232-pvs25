  ...
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">A list of all the perfumes in your account including their name, type, description
          and notes.</p>
...
?>
      ...
      <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
        <button type="button"
          ...
          <a href="<?php echo site_url() . '/admin/perfumes/create.php' ?>">
            Add perfume</a></button>
      </div>
    </div>
    <br>
    <br>
